export default function RecipeDetails({ open, onClose, modalDetails }) {
    return (
        // backdrop
        <div
            onClick={onClose}
          ...
          `}
            >
                ...
                <div className="w-7/10 p-4 shadow-md shadow-primary rounded-md bg-white">
                    ...
                    <ul className="p-2">
                        {modalDetails.ingredientLines?.map((item, index) => {
                            return (
                                <li
                                    key={index}
                                    className="text-secondary text-md font-bold"
                                >
                    ...
                    <div className="p-2 text-center mt-5">
                        <a
                            href={modalDetails.instructions}
                            target="_blank"
